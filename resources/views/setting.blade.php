                    ...
                    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="user[about_me]" id="biod" rows="3" class="form-control @error('user.about_me') is-invalid @enderror"
                                placeholder="In a few words, tell us about yourself">{{ old('user.about_me', $user->bio) }}</textarea>
                        </div>
                    </fieldset>
                    <fieldset class="mt-3">
                    ...
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            @error('social.instagram')
                                <div class="invalid-instagram">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    {{-- @if (old('options.email_notification.new_comment', $user->setting->email_notification['new_comment']) == 1)
                                        checked @endif
                                    > --}}
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    @if (old('options.email_notification.new_image', $user->setting->email_notification['new_image']) == 1)
                                        checked @endif
                                    >
